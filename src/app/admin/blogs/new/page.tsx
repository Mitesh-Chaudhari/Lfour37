...
export default function NewBlogPostPage() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      router.push(`/admin/blogs/${finalSlug}`)
    } catch {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <h1 className="text-2xl font-bold mt-2">New Blog Post</h1>
        <p className="text-sm text-gray-600 mt-1">
          Create the post, then write the full content in the editor. Check{' '}
          <strong>Published</strong> when ready to show it on the storefront.
        </p>
      </div>
      ...
      <div className="space-y-4 bg-white border rounded-xl p-6">
        ...
        <Input
          ...
          placeholder="summer-style-guide"
          helperText="Public URL: /blogs/your-slug"
        />
